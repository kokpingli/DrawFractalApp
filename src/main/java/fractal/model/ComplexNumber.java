...
public class ComplexNumber {
	...
	public ComplexNumber multiply(ComplexNumber other) {
		ComplexNumber multiplication = new ComplexNumber(real * other.real - imaginary * other.imaginary,
	...
	public ComplexNumber divide(ComplexNumber other) {
		...
		ComplexNumber division = new ComplexNumber(numerator.real / denominator.real,
